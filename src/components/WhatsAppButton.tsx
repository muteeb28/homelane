...
import { generateWhatsAppUrl } from '../utils/chatBot';

const WhatsAppButton: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message = "Hi! I'm interested in HomeLane's interior design services. I'd like to know more about your offerings and get a quote for my home.";
